...
<p>You can find links to data websites, all on the clear-web. Some sites will charge you for their service, however some will also offer a small amount of data for free. Always remember to consider what data you are allowed or not allowed to collect. These resources are not just for OSINT investigations, they are also for checking your own data. 
<br></br>
